...
public class Mover : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        /*transform.position = new Vector3(
            PlayerPrefs.GetFloat("PlayerXPos", 171.7297f), 
            PlayerPrefs.GetFloat("PlayerYPos", 1.101024f), 
            PlayerPrefs.GetFloat("PlayerZPos", -144.8396f));*/
    }
    ...
    private void Update()
    {
        ...
        /*PlayerYPos = transform.position.y;     Saves system!!!
