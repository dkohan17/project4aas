namespace EasyPeasyFirstPersonController
{
    ...
    public partial class FirstPersonController : MonoBehaviour
    {
        ...
        private float staminaRecoveryDelay = 0f;
        ...
        private void HandleMovement()
        {
            ...
            if (isSprinting)
            {
                staminaRecoveryDelay = 3f;
                staminaRecoveryTimer = 0f;

                staminaDrainTimer -= Time.deltaTime;
                if (staminaDrainTimer <= 0f)
                {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (staminaRecoveryTimer <= 0f && _stamina < 100)
                    {
                        _stamina = Mathf.Min(100, _stamina + 1);
                        staminaRecoveryTimer = 0.1f;
                        Debug.Log($"Stamina: {_stamina}");
                    }
                }
            }
